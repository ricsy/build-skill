...
def test_copy_rule_dir_to_parent(tmp_path):
    ...
    cfg = PackConfig(file_copy_rules=[FileCopyRule(from_="src", type="scripts", to="src")])
...
def test_copy_rule_dir_no_to(tmp_path):
    ...
    cfg = PackConfig(file_copy_rules=[FileCopyRule(from_="src", type="scripts")])
    packer = TarPacker(cfg)
    result = packer.pack("test-skill", str(tmp_path / "dist"), str(tmp_path / "skills"))
...
def test_copy_rule_dir_with_glob(tmp_path):
    ...
    cfg = PackConfig(file_copy_rules=[FileCopyRule(from_="src", type="scripts", to="src", glob="*.py")])
    packer = TarPacker(cfg)
    result = packer.pack("test-skill", str(tmp_path / "dist"), str(tmp_path / "skills"))
...
def test_copy_rule_file(tmp_path):
    ...
    cfg = PackConfig(file_copy_rules=[FileCopyRule(from_="config.yaml", type="scripts")])
    packer = TarPacker(cfg)
    result = packer.pack("test-skill", str(tmp_path / "dist"), str(tmp_path / "skills"))
...
def test_pack_excludes_pycache(tmp_path):
    ...
    cfg = PackConfig(
        file_copy_rules=[FileCopyRule(from_="src", type="scripts", to="src")],
